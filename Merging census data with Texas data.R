...
save(my_points, file = "LatLongCensusRow.Rdata")
save(tx, file = "txtracts.Rdata")

tx_latlon$tractrow <- my_points$tract
...
income_tract <- data.frame( GEOID =substr(income_popul$GEOID, 8, 18),
                            population_acs_2013 = income_popul$population,
                            median_income_acs_2013 = income_popul$B22008_001)
...
#save !!!! WOOO
save(tx_merged, file = "Texas1MSample_Merged.Rdata")
